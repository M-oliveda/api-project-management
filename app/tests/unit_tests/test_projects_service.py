...
from app.services import create_project, get_project, get_user_projects, update_project, delete_project
...
class TestProjectService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock project
        self.project = Project(id=uuid4(), name="Test Project",
    ...
    def test_get_user_projects(self):
        self.db.query().filter().offset().limit(
        ).all.return_value = [self.project]
